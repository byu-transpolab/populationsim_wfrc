...
We are going to build this synthetic population for Weber, Davis, Salt Lake, and Utah Counties in
...
puma_tract <- read_csv(puma_url, col_types = list(PUMA5CE = col_character())) %>%
  ...
  filter(PUMA %in% c(49001:49004, 11001:11002, 35001:35009, 57001:57002))
```
