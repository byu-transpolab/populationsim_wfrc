...
hhcoord <- left_join(house2, address2, by = "tazcom") %>% select(household_id,PUMA,TRACT,TAZ.x,NP,HHINCADJ,WIF, longitude, latitude) %>%
  arrange(household_id)
  colnames(hhcoord)[4] <- "TAZ"
...
write_csv(hhcoord, "output/synthetic_households_xy.csv")
```
