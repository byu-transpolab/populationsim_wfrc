...
Also, in order to put together all 42 columns of input data, the data must be collected from various sources. The data sources are as follows: the 2018 SE WFRC data file, the synthetic population files, <!-- other files here-->. 
...
empkey = read.csv("inputs/other/EMP_Key.csv")
kable(empkey)
```
