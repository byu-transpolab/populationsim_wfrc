...
For the WFRC SE data files, data from Box Elder is only used for Zones 1-135. The rest of the data is used from the SE 2018 file (which includes the other counties).
```{r, message=FALSE, warning=FALSE}
