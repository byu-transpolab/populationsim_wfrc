...
Note: Some districts when computted were not found in the QGIS TAZ table and therefore they are resprested by the value of 0. If this causes problems in ActivitySim, assumptions about district values can be made. For now, we keep them 0.
